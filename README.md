<h1 align="center" style="font-size: 50px;">Welcome to Iconverter project 👋</h1>
...
**WINDOWS:** Simply click twice on `Iconverter.pyw` or run using IDLE

**LINUX:** Not tested yet for GUIs
```bash
python3 Iconverter.pyw
```
